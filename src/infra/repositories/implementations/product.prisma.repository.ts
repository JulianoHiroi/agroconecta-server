...
import { ConnectProductToEstablishmentRequestDTO, ConnectProductToEstablishmentResponseDTO, CreateProductDTO, CreateProductResponseDTO, UpdateProductDTO, UpdateProductResponseDTO } from "../../../domain/products/@types/productsDTO";
